...
let pessoa2 = new Object()//Metodo "tracidional"

//Declarando e incializando um objeto já com propriedades
...
//Acessando uma propriedade composta por
//várias palavras -> sintaxe dos colchetes
console.log(pessoa3['data de nascimento'])

//Sintaxe dos colchetes SEMPRE funciona, mesmo com
//propriedades cujo nome é uma única palavra
...
// -> basta atribuir o valor de um nome de atributo, segundo
...
for(let atrib in pessoa3) {
    ...
    //Usando string template (usando o sinal 'crase' no ínicio e final)
    console.log(`Atributo: ${atrib}; valor:  ${pessoa3[atrib]}`)
}