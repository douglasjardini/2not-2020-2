...
function comparaNome(obj, nome) {
    //Retorna true se o atributo first_name do ojeto for igual a nome
    return obj.first_name === nome
}

console.time('FAUSTO')
//console.log(buscaSequencial(listaNomes, 'FAUSTO', comparaNome))
console.log(buscaSequencial(listaNomes, 'FAUSTO', (obj, nome) => obj.first_name === nome)) - //com arrow function
...
let pos = buscaSequencial(listaNomes, '10000', (obj, valor) => obj.frequency_total > valor) - //com arrow function
