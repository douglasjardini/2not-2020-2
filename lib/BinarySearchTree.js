...
module.exports = class BinarySearchTree {
    constructor() {
        this.root = null    // Raiz da árvores
    }
    ...
    // Insere um nodo em uma sub-árvore a partir da raiz indicada
    // Parâmetros:
    ...
    searchNode(root, key) {
        ...
        else return true   /// Encontrado o nodo que contem key
    }

    // Manda excluir o nodo com o key especificando (caso exista) e retorna
    ...
    removeNode(root, key) {
        ...
        // Caso 4: Key é igual ao data do root (encontrou o nodo a ser removido)
            ...
            // Caso 4a: exclusão do nodo folha (grau 0)
            if(root.left === null && root.right === null) {
                root = null
                return null
            }
            // caso 4b: Exclusão de nodo apenas com a subárvore à esquerda (grau 1)
            else if(root.left !== null && root.right === null) {
                root = root.left
                return root
            }
            // Caso 4c: Exclusão de nodo apenas com suárvore à direita (grau1)
            else if(root.left === null && root.right !== null) {
            root = root.right
            return root
            }
            // Caso 4d: Exclusão de nodo grau 2
                ...
                // momento, está duplicando na árvore
